    ...
    return [
      {
        name: "list_services",
        description:
          "List all services with optional filtering by company_id, category, and price range",
        inputSchema: {
          type: "object",
          properties: {
            company_id: {
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            duration: {
              type: "number",
              description: "Service duration in minutes (required, must be positive integer)",
            },
            category: {
              type: "string",
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            duration: {
              type: "number",
              description: "Service duration in minutes (optional, must be positive integer)",
            },
            category: {
              type: "string",
              description: "Service category (optional, max 100 characters)",
